describe("AiPlayer", function() {
  ...
  it("can play a perfect game as player 2", function() {
    var board = [1,0,0,0,0,0,0,0,0]; // p1 plays corner
    var side = 2;
